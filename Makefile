...
INCLUDES_ENVIRON=environ.hpp
SRC_ENVIRON=environ.cpp
OBJ_ENVIRON=environ.o
...
$(OBJ_ENVIRON): $(INCLUDES_ENVIRON) $(SRC_ENVIRON) 
	g++ -c $(CPPFLAGS) $(SRC_ENVIRON) $(LDFLAGS) $(LIBS)

$(OBJ_TEXTURE): $(INCLUDES_TEXTURE) $(SRC_TEXTURE) 
	g++ -c $(CPPFLAGS) $(SRC_TEXTURE) $(LDFLAGS) $(LIBS)

$(BIN): $(OBJ_FW) $(OBJ_SU) $(OBJ_OBJ) $(OBJ_CHAR1) $(OBJ_CHAR2) $(OBJ_ENVIRON) $(OBJ_TEXTURE) $(SRC_MAIN) 
	g++ $(CPPFLAGS) $(SRC_MAIN) $(OBJ_FW) $(OBJ_SU) $(OBJ_OBJ) $(OBJ_CHAR1) $(OBJ_CHAR2) $(OBJ_ENVIRON) $(OBJ_TEXTURE) -o $(BIN) $(LDFLAGS) $(LIBS)
