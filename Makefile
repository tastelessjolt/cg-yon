...
$(BIN): $(OBJ_FW) $(OBJ_SU) $(OBJ_OBJ) $(OBJ_CHAR1) $(OBJ_CHAR2) $(OBJ_ENVIRON) $(SRC_MAIN) 
	g++ $(CPPFLAGS) $(SRC_MAIN) $(OBJ_FW) $(OBJ_SU) $(OBJ_OBJ) $(OBJ_CHAR1) $(OBJ_CHAR2) $(OBJ_ENVIRON) -o $(BIN) $(LDFLAGS) $(LIBS)
